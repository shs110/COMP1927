...
IntList newIntList()
{
	struct IntListImpl *L;

	L = malloc(sizeof (struct IntListImpl));
	assert (L != NULL);
	L->size = 0;
	L->first = NULL;
	L->last = NULL;
