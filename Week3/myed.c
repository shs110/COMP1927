...
int main(int argc, char *argv[])
{
	...
	List lines;      // lines from input file as a List
	FILE *f;         // file handle
...
// showCurrLine(lines)
void showCurrLine(List lines)
{
	ItemShow(stdout,ListCurrent(lines));
	printf("\n");
}
